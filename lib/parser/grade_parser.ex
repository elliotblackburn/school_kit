  ...
  defp subject_grade_parsers() do
    [
      ...
      {"Science - Combined (Double Award)", :science_double_award,
       &ScienceGCSEDoubleAwardParser.parse/2},
      ...
      {"Music Tech (Vocational Quals)", :music_tech_vocational,
       &CambridgeNationalCertParser.parse/2},
      ...
      {"IT / iMedia / Digital Applications (Vocatinal Quals", :it_i_media_vocational,
       &BTECL1L2AwardParser.parse/2},
      {"WJEC L1/2 Voc Award - Subject 2", :wjec_vocational_2, &WJECL1L2VocationalParser.parse/2},
      {"WJEC L1/2 Voc Award - Subject 3", :wjec_vocational_3, &WJECL1L2VocationalParser.parse/2},
